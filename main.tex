...
\begin{document}
	...
	\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/circuits/blob/main/codes/2.8.cir
		wget https://github.com/Dhatrireddyy/circuits/blob/main/codes/2.7.py
	\end{lstlisting}
...
Use latex-tikz
	...
	\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/circuits/blob/main/codes/3.5.cir
		wget https://github.com/Dhatrireddyy/circuits/blob/main/codes/3.4.py
	\end{lstlisting}
